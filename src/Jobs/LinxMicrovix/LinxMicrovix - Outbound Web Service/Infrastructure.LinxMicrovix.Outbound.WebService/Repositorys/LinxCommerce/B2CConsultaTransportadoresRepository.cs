...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaTransportadoresRepository : IB2CConsultaTransportadoresRepository
    {
        ...
        private readonly IB2CConsultaTransportadoresCommandHandler _commandHandler;

        public B2CConsultaTransportadoresRepository(ICoreRepository coreRepository, IB2CConsultaTransportadoresCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaTransportadores());
