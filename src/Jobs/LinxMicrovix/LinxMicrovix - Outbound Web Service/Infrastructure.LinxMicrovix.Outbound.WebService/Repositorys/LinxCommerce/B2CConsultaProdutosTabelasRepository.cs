...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosTabelasRepository : IB2CConsultaProdutosTabelasRepository
    {
        ...
        public B2CConsultaProdutosTabelasRepository(ICoreRepository coreRepository, IB2CConsultaProdutosTabelasCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosTabelas());
