...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosTabelasPrecosRepository : IB2CConsultaProdutosTabelasPrecosRepository
    {
        ...
        private readonly IB2CConsultaProdutosTabelasPrecosCommandHandler _commandHandler;

        public B2CConsultaProdutosTabelasPrecosRepository(ICoreRepository coreRepository, IB2CConsultaProdutosTabelasPrecosCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosTabelasPrecos());
        ...
        public async Task<IEnumerable<string?>> GetRegistersExists(LinxAPIParam jobParameter, List<B2CConsultaProdutosTabelasPrecos> registros)
        {
