...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosDetalhesDepositosRepository : IB2CConsultaProdutosDetalhesDepositosRepository
    {
        ...
        public B2CConsultaProdutosDetalhesDepositosRepository(ICoreRepository coreRepository, IB2CConsultaProdutosDetalhesDepositosCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosDetalhesDepositos());
