...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxSetoresRepository : ILinxSetoresRepository
    {
        ...
        public LinxSetoresRepository(ICoreRepository coreRepository, ILinxSetoresCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxSetores());
