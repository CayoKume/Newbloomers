...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxXMLDocumentosRepository : ILinxXMLDocumentosRepository
    {
        ...
        private readonly ILinxXMLDocumentosCommandHandler _commandHandler;

        public LinxXMLDocumentosRepository(ICoreRepository coreRepository, ILinxXMLDocumentosCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxXMLDocumentos());
