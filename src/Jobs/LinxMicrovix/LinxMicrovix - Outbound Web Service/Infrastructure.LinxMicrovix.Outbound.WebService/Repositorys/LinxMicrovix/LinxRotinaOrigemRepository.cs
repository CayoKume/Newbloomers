...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxRotinaOrigemRepository : ILinxRotinaOrigemRepository
    {
        ...
        public LinxRotinaOrigemRepository(ICoreRepository coreRepository, ILinxRotinaOrigemCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxRotinaOrigem());
