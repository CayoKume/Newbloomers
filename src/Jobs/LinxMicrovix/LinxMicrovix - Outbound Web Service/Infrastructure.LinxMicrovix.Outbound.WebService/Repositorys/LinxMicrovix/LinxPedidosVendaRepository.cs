...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxPedidosVendaRepository : ILinxPedidosVendaRepository
    {
        ...
        public LinxPedidosVendaRepository(ICoreRepository coreRepository, ILinxPedidosVendaCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxPedidosVenda());
