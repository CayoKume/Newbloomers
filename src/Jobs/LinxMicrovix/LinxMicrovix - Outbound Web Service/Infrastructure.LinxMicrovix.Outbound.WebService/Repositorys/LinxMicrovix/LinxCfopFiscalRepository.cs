...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxCfopFiscalRepository : ILinxCfopFiscalRepository
    {
        ...
        public LinxCfopFiscalRepository(ICoreRepository coreRepository, ILinxCfopFiscalCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxCfopFiscal());
