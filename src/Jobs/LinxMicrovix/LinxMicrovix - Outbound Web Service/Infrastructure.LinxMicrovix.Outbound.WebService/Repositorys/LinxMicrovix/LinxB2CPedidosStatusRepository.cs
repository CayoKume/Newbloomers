...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxB2CPedidosStatusRepository : ILinxB2CPedidosStatusRepository
    {
        ...
        public LinxB2CPedidosStatusRepository(ICoreRepository coreRepository, ILinxB2CPedidosStatusCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxB2CPedidosStatus());
