...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaProdutosPromocaoService : IB2CConsultaProdutosPromocaoService
    {
        ...
        private readonly IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxCommerce.B2CConsultaProdutosPromocao> _validator;
        ...
        public B2CConsultaProdutosPromocaoService(
            ...
            IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxCommerce.B2CConsultaProdutosPromocao> validator,
        ...
        public List<B2CConsultaProdutosPromocao?> DeserializeXMLToObject(LinxAPIParam jobParameter, List<Dictionary<string?, string?>> records)
        {
            ...
            for (int i = 0; i < records.Count(); i++)
            {
                try
                {
                    ...
                    list.Add(new B2CConsultaProdutosPromocao(entity, xml));
                }
                catch (Exception ex)
                {
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            foreach (var cnpj_emp in cnpjs_emp)
            {
                ...
                if (xmls.Count() > 0)
                {
                    ...
                    if (_b2cConsultaProdutosPromocaoCache.Count == 0)
                    {
                        ...
                        _b2cConsultaProdutosPromocaoCache = list_existentes.ToList();
                    }

                    var _listSomenteNovos = listRecords.Where(x => !_b2cConsultaProdutosPromocaoCache.Any(y =>
                        y == x.recordKey
                    )).ToList();
                    ...
                    if (_listSomenteNovos.Count() > 0)
                    {
                        ...
                        _b2cConsultaProdutosPromocaoCache.AddRange(_listSomenteNovos.Select(x => x.recordKey));
                    }
