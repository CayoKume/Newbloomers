...
namespace Application.LinxMicrovix.Outbound.WebService.Services.LinxMicrovix
{
    public class LinxPedidosVendaService : ILinxPedidosVendaService
    {
        ...
        private readonly IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxPedidosVenda> _validator;
        ...
        public LinxPedidosVendaService(
            ...
            IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxPedidosVenda> validator,
        ...
        public List<LinxPedidosVenda?> DeserializeXMLToObject(LinxAPIParam jobParameter, List<Dictionary<string?, string?>> records)
        {
            ...
            for (int i = 0; i < records.Count(); i++)
            {
                try
                {
                    var entity = new Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxPedidosVenda(
                    ...
                    list.Add(new LinxPedidosVenda(entity, xml));
                }
                catch (Exception ex)
                {
