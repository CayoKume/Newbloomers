...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Data.Mappings.LinxMicrovix
{
    public class LinxB2CPedidosTrustedMap : IEntityTypeConfiguration<LinxB2CPedidos>
    {
        ...
        {
            builder.ToTable("LinxB2CPedidos", "linx_microvix_erp");
    ...
    public class LinxB2CPedidosRawMap : IEntityTypeConfiguration<LinxB2CPedidos>
    {
        public void Configure(EntityTypeBuilder<LinxB2CPedidos> builder)
        {
            builder.ToTable("LinxB2CPedidos", "untreated");
