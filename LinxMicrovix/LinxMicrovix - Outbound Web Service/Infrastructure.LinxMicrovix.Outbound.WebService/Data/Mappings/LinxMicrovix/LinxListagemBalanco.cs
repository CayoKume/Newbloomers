...
{
    public class LinxListagemBalancoTrustedMap : IEntityTypeConfiguration<LinxListagemBalanco>
    {
        public void Configure(EntityTypeBuilder<LinxListagemBalanco> builder)
        {
            builder.ToTable("LinxListagemBalanco", "linx_microvix_erp");
    ...
    public class LinxListagemBalancoRawMap : IEntityTypeConfiguration<LinxListagemBalanco>
    {
        public void Configure(EntityTypeBuilder<LinxListagemBalanco> builder)
        {
            builder.ToTable("LinxListagemBalanco", "untreated");
