...
{
    public class LinxMovimentoDevolucoesItensTrustedMap : IEntityTypeConfiguration<LinxMovimentoDevolucoesItens>
    {
        public void Configure(EntityTypeBuilder<LinxMovimentoDevolucoesItens> builder)
        {
            builder.ToTable("LinxMovimentoDevolucoesItens", "linx_microvix_erp");
    ...
    public class LinxMovimentoDevolucoesItensRawMap : IEntityTypeConfiguration<LinxMovimentoDevolucoesItens>
    {
        public void Configure(EntityTypeBuilder<LinxMovimentoDevolucoesItens> builder)
        {
            builder.ToTable("LinxMovimentoDevolucoesItens", "untreated");
