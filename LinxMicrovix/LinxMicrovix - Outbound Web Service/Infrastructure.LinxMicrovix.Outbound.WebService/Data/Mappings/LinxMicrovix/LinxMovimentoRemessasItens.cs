...
{
    public class LinxMovimentoRemessasItensTrustedMap : IEntityTypeConfiguration<LinxMovimentoRemessasItens>
    {
        public void Configure(EntityTypeBuilder<LinxMovimentoRemessasItens> builder)
        {
            builder.ToTable("LinxMovimentoRemessasItens", "linx_microvix_erp");
    ...
    public class LinxMovimentoRemessasItensRawMap : IEntityTypeConfiguration<LinxMovimentoRemessasItens>
    {
        public void Configure(EntityTypeBuilder<LinxMovimentoRemessasItens> builder)
        {
            builder.ToTable("LinxMovimentoRemessasItens", "untreated");
