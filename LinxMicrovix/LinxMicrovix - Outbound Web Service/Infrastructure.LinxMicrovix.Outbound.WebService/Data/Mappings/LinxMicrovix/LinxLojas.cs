...
{
    public class LinxLojasTrustedMap : IEntityTypeConfiguration<LinxLojas>
    {
        public void Configure(EntityTypeBuilder<LinxLojas> builder)
        {
            builder.ToTable("LinxLojas", "linx_microvix_erp");
    ...
    public class LinxLojasRawMap : IEntityTypeConfiguration<LinxLojas>
    {
        public void Configure(EntityTypeBuilder<LinxLojas> builder)
        {
            builder.ToTable("LinxLojas", "untreated");
