...
{
    public class LinxAntecipacoesFinanceirasPlanosTrustedMap : IEntityTypeConfiguration<LinxAntecipacoesFinanceirasPlanos>
    {
        public void Configure(EntityTypeBuilder<LinxAntecipacoesFinanceirasPlanos> builder)
        {
            builder
                .ToTable("LinxAntecipacoesFinanceirasPlanos", "linx_microvix_erp")
                .HasKey(x => x.plano);
    ...
    public class LinxAntecipacoesFinanceirasPlanosRawMap : IEntityTypeConfiguration<LinxAntecipacoesFinanceirasPlanos>
    {
        public void Configure(EntityTypeBuilder<LinxAntecipacoesFinanceirasPlanos> builder)
        {
            builder
