...
{
    public class LinxMovimentoPrincipalTrustedMap : IEntityTypeConfiguration<LinxMovimentoPrincipal>
    {
        public void Configure(EntityTypeBuilder<LinxMovimentoPrincipal> builder)
        {
            builder.ToTable("LinxMovimentoPrincipal", "linx_microvix_erp");
    ...
    public class LinxMovimentoPrincipalRawMap : IEntityTypeConfiguration<LinxMovimentoPrincipal>
    {
        public void Configure(EntityTypeBuilder<LinxMovimentoPrincipal> builder)
        {
            builder.ToTable("LinxMovimentoPrincipal", "untreated");
