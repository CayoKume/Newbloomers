...
{
    public class LinxPlanosPedidoVendaTrustedMap : IEntityTypeConfiguration<LinxPlanosPedidoVenda>
    {
        public void Configure(EntityTypeBuilder<LinxPlanosPedidoVenda> builder)
        {
            builder.ToTable("LinxPlanosPedidoVenda", "linx_microvix_erp");
    ...
    public class LinxPlanosPedidoVendaRawMap : IEntityTypeConfiguration<LinxPlanosPedidoVenda>
    {
        public void Configure(EntityTypeBuilder<LinxPlanosPedidoVenda> builder)
        {
            builder.ToTable("LinxPlanosPedidoVenda", "untreated");
