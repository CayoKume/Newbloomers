...
{
    public class LinxMovimentoPlanosTrustedMap : IEntityTypeConfiguration<LinxMovimentoPlanos>
    {
        public void Configure(EntityTypeBuilder<LinxMovimentoPlanos> builder)
        {
            builder.ToTable("LinxMovimentoPlanos", "linx_microvix_erp");
    ...
    public class LinxMovimentoPlanosRawMap : IEntityTypeConfiguration<LinxMovimentoPlanos>
    {
        public void Configure(EntityTypeBuilder<LinxMovimentoPlanos> builder)
        {
            builder.ToTable("LinxMovimentoPlanos", "untreated");
