...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Data.Mappings.LinxMicrovix
{
    public class LinxDadosOpticosDavMap : IEntityTypeConfiguration<LinxDadosOpticosDav>
    {
        ...
        {
            builder.ToTable("LinxDadosOpticosDav", "linx_microvix_erp");
    ...
    public class LinxDadosOpticosDavRawMap : IEntityTypeConfiguration<LinxDadosOpticosDav>
    {
        public void Configure(EntityTypeBuilder<LinxDadosOpticosDav> builder)
        {
            builder.ToTable("LinxDadosOpticosDav", "untreated");
