...
{
    public class LinxConfiguracoesTributariasDetalhesTrustedMap : IEntityTypeConfiguration<LinxConfiguracoesTributariasDetalhes>
    {
        public void Configure(EntityTypeBuilder<LinxConfiguracoesTributariasDetalhes> builder)
        {
            builder.ToTable("LinxConfiguracoesTributariasDetalhes", "linx_microvix_erp");
    ...
    public class LinxConfiguracoesTributariasDetalhesRawMap : IEntityTypeConfiguration<LinxConfiguracoesTributariasDetalhes>
    {
        public void Configure(EntityTypeBuilder<LinxConfiguracoesTributariasDetalhes> builder)
        {
            builder.ToTable("LinxConfiguracoesTributariasDetalhes", "untreated");
