...
{
    public class LinxFaturasTrustedMap : IEntityTypeConfiguration<LinxFaturas>
    {
        public void Configure(EntityTypeBuilder<LinxFaturas> builder)
        {
            builder.ToTable("LinxFaturas", "linx_microvix_erp");
    ...
    public class LinxFaturasRawMap : IEntityTypeConfiguration<LinxFaturas>
    {
        public void Configure(EntityTypeBuilder<LinxFaturas> builder)
        {
            builder.ToTable("LinxFaturas", "untreated");
