...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Data.Mappings.LinxMicrovix
{
    public class LinxPedidosVendaMap : IEntityTypeConfiguration<LinxPedidosVenda>
    {
        ...
        {
            builder.ToTable("LinxPedidosVenda", "linx_microvix_erp");
    ...
    public class LinxPedidosVendaRawMap : IEntityTypeConfiguration<LinxPedidosVenda>
    {
        public void Configure(EntityTypeBuilder<LinxPedidosVenda> builder)
        {
            builder.ToTable("LinxPedidosVenda", "untreated");
