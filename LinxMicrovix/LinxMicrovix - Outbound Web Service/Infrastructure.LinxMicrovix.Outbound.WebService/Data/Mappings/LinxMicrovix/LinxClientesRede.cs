...
{
    public class LinxClientesRedeTrustedMap : IEntityTypeConfiguration<LinxClientesRede>
    {
        public void Configure(EntityTypeBuilder<LinxClientesRede> builder)
        {
            builder.ToTable("LinxClientesRede", "linx_microvix_erp");
    ...
    public class LinxClientesRedeRawMap : IEntityTypeConfiguration<LinxClientesRede>
    {
        public void Configure(EntityTypeBuilder<LinxClientesRede> builder)
        {
        builder.ToTable("LinxClientesRede", "untreated");
