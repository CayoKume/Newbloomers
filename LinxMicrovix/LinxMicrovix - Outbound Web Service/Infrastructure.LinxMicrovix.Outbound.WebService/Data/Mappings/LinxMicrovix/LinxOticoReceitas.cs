...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Data.Mappings.LinxMicrovix
{
    public class LinxOticoReceitasMap : IEntityTypeConfiguration<LinxOticoReceitas>
    {
        ...
        {
            builder.ToTable("LinxOticoReceitas", "linx_microvix_erp");
    ...
    public class LinxOticoReceitasRawMap : IEntityTypeConfiguration<LinxOticoReceitas>
    {
        public void Configure(EntityTypeBuilder<LinxOticoReceitas> builder)
        {
            builder.ToTable("LinxOticoReceitas", "untreated");
