...
{
    public class LinxConfiguracoesTributariasTrustedMap : IEntityTypeConfiguration<LinxConfiguracoesTributarias>
    {
        public void Configure(EntityTypeBuilder<LinxConfiguracoesTributarias> builder)
        {
            builder.ToTable("LinxConfiguracoesTributarias", "linx_microvix_erp");
    ...
    public class LinxConfiguracoesTributariasRawMap : IEntityTypeConfiguration<LinxConfiguracoesTributarias>
    {
        public void Configure(EntityTypeBuilder<LinxConfiguracoesTributarias> builder)
        {
            builder.ToTable("LinxConfiguracoesTributarias", "untreated");
