...
{
    public class LinxCsosnFiscalTrustedMap : IEntityTypeConfiguration<LinxCsosnFiscal>
    {
    ...
    public class LinxCsosnFiscalRawMap : IEntityTypeConfiguration<LinxCsosnFiscal>
    {
        public void Configure(EntityTypeBuilder<LinxCsosnFiscal> builder)
        {
