...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaEspessurasRepository : IB2CConsultaEspessurasRepository
    {
        ...
        private readonly IB2CConsultaEspessurasCommandHandler _commandHandler;

        public B2CConsultaEspessurasRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaEspessurasCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaEspessuras());
