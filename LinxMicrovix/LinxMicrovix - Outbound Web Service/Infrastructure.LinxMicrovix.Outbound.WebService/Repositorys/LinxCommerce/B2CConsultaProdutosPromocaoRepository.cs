...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosPromocaoRepository : IB2CConsultaProdutosPromocaoRepository
    {
        ...
        private readonly IB2CConsultaProdutosPromocaoCommandHandler _commandHandler;

        public B2CConsultaProdutosPromocaoRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaProdutosPromocaoCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosPromocao());
