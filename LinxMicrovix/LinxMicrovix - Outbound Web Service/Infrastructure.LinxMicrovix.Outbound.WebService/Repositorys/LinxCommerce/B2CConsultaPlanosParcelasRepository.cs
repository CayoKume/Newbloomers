...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaPlanosParcelasRepository : IB2CConsultaPlanosParcelasRepository
    {
        ...
        public async Task<List<B2CConsultaPlanosParcelas>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaPlanosParcelas> registros)
        {
            try
            {
                ...
                string sql = $"SELECT ID_PLANOS_PARCELAS, TIMESTAMP FROM B2CCONSULTACLIENTES_TRUSTED WHERE ID_PLANOS_PARCELAS IN ({identificadores})";
