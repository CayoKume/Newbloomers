...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaTiposCobrancaFreteRepository : IB2CConsultaTiposCobrancaFreteRepository
    {
        ...
        public async Task<List<B2CConsultaTiposCobrancaFrete>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaTiposCobrancaFrete> registros)
        {
            try
            {
