...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosCodebarRepository : IB2CConsultaProdutosCodebarRepository
    {
        ...
        public B2CConsultaProdutosCodebarRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaProdutosCodebarCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosCodebar());
