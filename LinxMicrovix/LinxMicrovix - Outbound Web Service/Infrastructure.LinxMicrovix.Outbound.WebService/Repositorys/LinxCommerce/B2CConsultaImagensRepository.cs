...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaImagensRepository : IB2CConsultaImagensRepository
    {
        ...
        private readonly IB2CConsultaImagensCommandHandler _commandHandler;

        public B2CConsultaImagensRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaImagensCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaImagens());
