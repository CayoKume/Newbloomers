...
;
        ...
        public async Task<List<B2CConsultaClientesEnderecosEntrega>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaClientesEnderecosEntrega> registros)
        {
            try
            {
