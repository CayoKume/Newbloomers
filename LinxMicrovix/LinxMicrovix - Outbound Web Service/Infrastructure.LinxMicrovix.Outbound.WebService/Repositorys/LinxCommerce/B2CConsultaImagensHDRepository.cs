...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaImagensHDRepository : IB2CConsultaImagensHDRepository
    {
        ...
        private readonly IB2CConsultaImagensHDCommandHandler _commandHandler;

        public B2CConsultaImagensHDRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaImagensHDCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaImagensHD());
