...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaTagsRepository : IB2CConsultaTagsRepository
    {
        ...
        public B2CConsultaTagsRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaTagsCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaTags());
