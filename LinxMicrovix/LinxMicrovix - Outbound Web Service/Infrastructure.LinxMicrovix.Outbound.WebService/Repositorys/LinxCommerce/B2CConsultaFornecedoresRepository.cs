...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaFornecedoresRepository : IB2CConsultaFornecedoresRepository
    {
        ...
        private readonly IB2CConsultaFornecedoresCommandHandler _commandHandler;

        public B2CConsultaFornecedoresRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaFornecedoresCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaFornecedores());
