...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaEmpresasRepository : IB2CConsultaEmpresasRepository
    {
        ...
        public bool BulkInsertIntoTableRaw(LinxMicrovixJobParameter jobParameter, IList<B2CConsultaEmpresas> records)
        {
            try
            {
        ...
        public async Task<List<B2CConsultaEmpresas>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaEmpresas> registros)
        {
            try
            {
