...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosDimensoesRepository : IB2CConsultaProdutosDimensoesRepository
    {
        ...
        private readonly IB2CConsultaProdutosDimensoesCommandHandler _commandHandler;

        public B2CConsultaProdutosDimensoesRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaProdutosDimensoesCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosDimensoes());
