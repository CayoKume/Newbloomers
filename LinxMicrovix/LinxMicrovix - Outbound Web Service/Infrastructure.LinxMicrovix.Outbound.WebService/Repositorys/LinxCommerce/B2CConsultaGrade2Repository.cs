...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaGrade2Repository : IB2CConsultaGrade2Repository
    {
        ...
        public bool BulkInsertIntoTableRaw(LinxMicrovixJobParameter jobParameter, IList<B2CConsultaGrade2> records)
        {
            try
            {
        ...
        public async Task<List<B2CConsultaGrade2>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaGrade2> registros)
        {
            try
            {
        ...
        public async Task<bool> InsertRecord(LinxMicrovixJobParameter jobParameter, B2CConsultaGrade2? record)
        {
