...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaGrade2Repository : IB2CConsultaGrade2Repository
    {
        ...
        private readonly IB2CConsultaGrade2CommandHandler _commandHandler;

        public B2CConsultaGrade2Repository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaGrade2CommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaGrade2());
