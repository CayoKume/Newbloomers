...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaPedidosStatusRepository : IB2CConsultaPedidosStatusRepository
    {
        ...
        public async Task<List<B2CConsultaPedidosStatus>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaPedidosStatus> registros)
        {
            try
            {
                ...
                string sql = $"SELECT ID_PEDIDO, TIMESTAMP FROM B2CCONSULTAPEDIDOSSTATUS_TRUSTED WHERE ID_PEDIDO IN ({identificadores})";
