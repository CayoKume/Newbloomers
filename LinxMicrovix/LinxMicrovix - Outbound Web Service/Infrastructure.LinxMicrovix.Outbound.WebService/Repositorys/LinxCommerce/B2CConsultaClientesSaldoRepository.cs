...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaClientesSaldoRepository : IB2CConsultaClientesSaldoRepository
    {
        ...
        public bool BulkInsertIntoTableRaw(LinxMicrovixJobParameter jobParameter, IList<B2CConsultaClientesSaldo> records)
        {
            try
            {
        ...
        public async Task<List<B2CConsultaClientesSaldo>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaClientesSaldo> registros)
        {
            try
            {
                ...
                string sql = $"SELECT COD_CLIENTE_ERP, TIMESTAMP FROM B2CCONSULTACLIENTESSALDO_TRUSTED WHERE COD_CLIENTE_ERP IN ({identificadores})";
