...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaLinhasRepository : IB2CConsultaLinhasRepository
    {
        ...
        private readonly IB2CConsultaLinhasCommandHandler _commandHandler;

        public B2CConsultaLinhasRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaLinhasCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaLinhas());
