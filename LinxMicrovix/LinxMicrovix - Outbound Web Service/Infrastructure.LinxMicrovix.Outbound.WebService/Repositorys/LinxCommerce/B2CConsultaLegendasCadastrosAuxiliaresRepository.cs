...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaLegendasCadastrosAuxiliaresRepository : IB2CConsultaLegendasCadastrosAuxiliaresRepository
    {
        ...
        private readonly IB2CConsultaLegendasCadastrosAuxiliaresCommandHandler _commandHandler;

        public B2CConsultaLegendasCadastrosAuxiliaresRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaLegendasCadastrosAuxiliaresCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaLegendasCadastrosAuxiliares());
