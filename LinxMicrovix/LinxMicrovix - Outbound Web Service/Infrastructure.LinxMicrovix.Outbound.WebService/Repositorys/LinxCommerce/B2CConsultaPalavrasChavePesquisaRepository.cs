...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaPalavrasChavePesquisaRepository : IB2CConsultaPalavrasChavePesquisaRepository
    {
        ...
        public async Task<List<B2CConsultaPalavrasChavePesquisa>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaPalavrasChavePesquisa> registros)
        {
            try
            {
