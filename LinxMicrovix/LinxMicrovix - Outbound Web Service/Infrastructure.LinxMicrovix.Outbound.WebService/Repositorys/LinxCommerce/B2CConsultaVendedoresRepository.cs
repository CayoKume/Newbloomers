...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaVendedoresRepository : IB2CConsultaVendedoresRepository
    {
        ...
        public async Task<List<B2CConsultaVendedores>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaVendedores> registros)
        {
            try
            {
                ...
                string sql = $"SELECT COD_VENDEDOR, TIMESTAMP FROM B2CCONSULTAVENDEDORES_TRUSTED WHERE COD_VENDEDOR IN ({identificadores})";
