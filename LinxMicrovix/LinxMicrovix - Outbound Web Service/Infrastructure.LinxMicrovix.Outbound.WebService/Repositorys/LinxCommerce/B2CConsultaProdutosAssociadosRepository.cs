...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosAssociadosRepository : IB2CConsultaProdutosAssociadosRepository
    {
        ...
        public B2CConsultaProdutosAssociadosRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaProdutosAssociadosCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosAssociados());
