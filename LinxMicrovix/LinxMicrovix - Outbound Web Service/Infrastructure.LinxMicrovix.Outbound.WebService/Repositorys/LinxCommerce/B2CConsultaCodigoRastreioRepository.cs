...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaCodigoRastreioRepository : IB2CConsultaCodigoRastreioRepository
    {
        ...
        private readonly IB2CConsultaCodigoRastreioCommandHandler _commandHandler;

        public B2CConsultaCodigoRastreioRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaCodigoRastreioCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaCodigoRastreio());
