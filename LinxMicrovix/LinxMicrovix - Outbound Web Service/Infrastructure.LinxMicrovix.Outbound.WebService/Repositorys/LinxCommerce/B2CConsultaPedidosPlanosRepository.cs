...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaPedidosPlanosRepository : IB2CConsultaPedidosPlanosRepository
    {
        ...
        private readonly IB2CConsultaPedidosPlanosCommandHandler _commandHandler;

        public B2CConsultaPedidosPlanosRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaPedidosPlanosCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaPedidosPlanos());
        ...
        public async Task<IEnumerable<string?>> GetRegistersExists(LinxAPIParam jobParameter, List<B2CConsultaPedidosPlanos> registros)
        {
