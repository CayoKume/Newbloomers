...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaUnidadeRepository : IB2CConsultaUnidadeRepository
    {
        ...
        public async Task<List<B2CConsultaUnidade>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaUnidade> registros)
        {
            try
            {
                ...
                string sql = $"SELECT UNIDADE, TIMESTAMP FROM B2CCONSULTAUNIDADE_TRUSTED WHERE UNIDADE IN ({identificadores})";
