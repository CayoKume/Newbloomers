...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaUnidadeRepository : IB2CConsultaUnidadeRepository
    {
        ...
        private readonly IB2CConsultaUnidadeCommandHandler _commandHandler;

        public B2CConsultaUnidadeRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaUnidadeCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaUnidade());
