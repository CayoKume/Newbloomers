...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaTransportadoresRepository : IB2CConsultaTransportadoresRepository
    {
        ...
        public B2CConsultaTransportadoresRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaTransportadoresCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaTransportadores());
