...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosTabelasRepository : IB2CConsultaProdutosTabelasRepository
    {
        ...
        private readonly IB2CConsultaProdutosTabelasCommandHandler _commandHandler;

        public B2CConsultaProdutosTabelasRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaProdutosTabelasCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosTabelas());
        ...
        public async Task<IEnumerable<string?>> GetRegistersExists(LinxAPIParam jobParameter, List<B2CConsultaProdutosTabelas> registros)
        {
