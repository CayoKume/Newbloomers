...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaSetoresRepository : IB2CConsultaSetoresRepository
    {
        ...
        private readonly IB2CConsultaSetoresCommandHandler _commandHandler;

        public B2CConsultaSetoresRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaSetoresCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaSetores());
        ...
        public async Task<IEnumerable<string?>> GetRegistersExists(LinxAPIParam jobParameter, List<B2CConsultaSetores> registros)
        {
