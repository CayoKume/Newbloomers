...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaColecoesRepository : IB2CConsultaColecoesRepository
    {
        ...
        public async Task<List<B2CConsultaColecoes>> GetRegistersExists(LinxMicrovixJobParameter jobParameter, List<B2CConsultaColecoes> registros)
        {
            try
            {
                ...
                string sql = $"SELECT CODIGO_COLECAO, TIMESTAMP FROM B2CCONSULTACOLECOES_TRUSTED WHERE CODIGO_COLECAO IN ({identificadores})";
