...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaColecoesRepository : IB2CConsultaColecoesRepository
    {
        ...
        private readonly IB2CConsultaColecoesCommandHandler _commandHandler;

        public B2CConsultaColecoesRepository(IIntegrationsCoreRepository integrationsCoreRepository, IB2CConsultaColecoesCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaColecoes());
