...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxMovimentoRepository : ILinxMovimentoRepository
    {
        ...
        private readonly ILinxMovimentoCommandHandler _commandHandler;

        public LinxMovimentoRepository(IIntegrationsCoreRepository integrationsCoreRepository, ILinxMovimentoCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxMovimento());
