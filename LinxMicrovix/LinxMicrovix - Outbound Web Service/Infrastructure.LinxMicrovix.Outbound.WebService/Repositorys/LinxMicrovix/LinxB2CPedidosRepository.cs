...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxB2CPedidosRepository : ILinxB2CPedidosRepository
    {
        ...
        private readonly ILinxB2CPedidosCommandHandler _commandHandler;

        public LinxB2CPedidosRepository(IIntegrationsCoreRepository integrationsCoreRepository, ILinxB2CPedidosCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxB2CPedidos());
