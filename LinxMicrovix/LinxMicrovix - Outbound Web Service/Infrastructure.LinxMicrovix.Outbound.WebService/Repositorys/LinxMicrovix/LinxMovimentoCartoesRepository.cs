...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxMovimentoCartoesRepository : ILinxMovimentoCartoesRepository
    {
        ...
        public LinxMovimentoCartoesRepository(IIntegrationsCoreRepository integrationsCoreRepository, ILinxMovimentoCartoesCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxMovimentoCartoes());
