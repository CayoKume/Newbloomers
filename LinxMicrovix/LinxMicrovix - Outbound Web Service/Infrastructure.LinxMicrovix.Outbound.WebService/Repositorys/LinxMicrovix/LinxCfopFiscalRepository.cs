...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxCfopFiscalRepository : ILinxCfopFiscalRepository
    {
        ...
        private readonly ILinxCfopFiscalCommandHandler _commandHandler;

        public LinxCfopFiscalRepository(IIntegrationsCoreRepository integrationsCoreRepository, ILinxCfopFiscalCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxCfopFiscal());
