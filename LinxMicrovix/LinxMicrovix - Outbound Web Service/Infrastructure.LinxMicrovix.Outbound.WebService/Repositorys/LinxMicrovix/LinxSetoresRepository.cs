...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxSetoresRepository : ILinxSetoresRepository
    {
        ...
        private readonly ILinxSetoresCommandHandler _commandHandler;

        public LinxSetoresRepository(IIntegrationsCoreRepository integrationsCoreRepository, ILinxSetoresCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxSetores());
