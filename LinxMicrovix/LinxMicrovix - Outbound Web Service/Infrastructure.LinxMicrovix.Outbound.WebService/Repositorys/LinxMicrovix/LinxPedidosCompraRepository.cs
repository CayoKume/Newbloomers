...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxPedidosCompraRepository : ILinxPedidosCompraRepository
    {
        ...
        private readonly ILinxPedidosCompraCommandHandler _commandHandler;

        public LinxPedidosCompraRepository(IIntegrationsCoreRepository integrationsCoreRepository, ILinxPedidosCompraCommandHandler commandHandler)
        {
        ...
        {
            var table = _integrationsCoreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxPedidosCompra());
