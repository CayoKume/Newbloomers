...
{
    public abstract class LinxProdutos
    {
        ...
        public string? id_tamanho { get; set; }
        ...
        public string? fator_conversao { get; set; }
        public string? codigo_integracao_ws { get; set; }
        public string? codigo_integracao_reshop { get; set; }
        public string? id_produtos_opticos_tipo { get; set; }
        public string? id_sped_tipo_item { get; set; }
        public string? componente { get; set; }
        public string? altura_para_frete { get; set; }
        public string? largura_para_frete { get; set; }
        public string? comprimento_para_frete { get; set; }
        public string? loja_virtual { get; set; }
        public string? cod_comprador { get; set; }
        public string? obrigatorio_identificacao_cliente { get; set; }
