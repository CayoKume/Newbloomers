...
{
    public abstract class LinxPedidosCompra
    {
        ...
        public string? numero_ped_fornec { get; set; }
        ...
        public string? qtde_entregue { get; set; }
        public string? descricao_frete { get; set; }
        public string? integrado_linx { get; set; }
        public string? nf_gerada { get; set; }
        public string? timestamp { get; set; }
        public string? empresa { get; set; }
        public string? nf_origem_ws { get; set; }
    }
}
