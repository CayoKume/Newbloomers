namespace Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix
{
    public class LinxConfiguracoesTributariasDetalhesSimplificado
    {
        ...
        public LinxConfiguracoesTributariasDetalhesSimplificado(string? id_configuracao_tributaria_detalhe, string? id_configuracao_tributaria, string? tipo_tributacao, string? aliquota, string? timestamp, string? portal)
        {
