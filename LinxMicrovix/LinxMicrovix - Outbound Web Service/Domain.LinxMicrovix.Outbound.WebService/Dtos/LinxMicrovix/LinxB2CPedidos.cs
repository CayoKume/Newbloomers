namespace Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix
{
    public class LinxB2CPedidos
    {
        ...
        public LinxB2CPedidos(string? id_pedido, string? dt_pedido, string? cod_cliente_erp, string? cod_cliente_b2c, string? vl_frete, string? forma_pgto, string? plano_pagamento, string? anotacao, string? taxa_impressao, string? finalizado, string? valor_frete_gratis, string? tipo_frete, string? id_status, string? cod_transportador, string? tipo_cobranca_frete, string? ativo, string? empresa, string? id_tabela_preco, string? valor_credito, string? cod_vendedor, string? timestamp, string? dt_insert, string? dt_disponivel_faturamento, string? portal, string? mensagem_falha_faturamento, string? id_tipo_b2c, string? ecommerce_origem, string? order_id)
        {
