...
{
    public class B2CConsultaVendedoresRepository<TEntity> : IB2CConsultaVendedoresRepository<TEntity> where TEntity : B2CConsultaVendedores, new()
    {
        private readonly ILinxMicrovixRepositoryBase<TEntity> _linxMicrovixRepositoryBase;

        public B2CConsultaVendedoresRepository(ILinxMicrovixRepositoryBase<TEntity> linxMicrovixRepositoryBase) =>
