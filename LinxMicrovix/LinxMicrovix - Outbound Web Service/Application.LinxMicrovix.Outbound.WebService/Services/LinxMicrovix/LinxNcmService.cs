...
namespace Application.LinxMicrovix.Outbound.WebService.Services.LinxMicrovix
{
    public class LinxNcmService : ILinxNcmService
    {
        ...
        private readonly ILinxMicrovixAzureSQLRepositoryBase<LinxNcm> _linxMicrovixRepositoryBase;

        public LinxNcmService(
            IAPICall apiCall,
            ILoggerService logger,
            ILinxMicrovixServiceBase linxMicrovixServiceBase,
            ILinxMicrovixAzureSQLRepositoryBase<LinxNcm> linxMicrovixRepositoryBase
        )
        {
            _apiCall = apiCall;
            _logger = logger;
