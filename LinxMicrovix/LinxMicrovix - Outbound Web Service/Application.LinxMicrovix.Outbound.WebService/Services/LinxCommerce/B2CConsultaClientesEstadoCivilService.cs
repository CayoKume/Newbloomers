...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaClientesEstadoCivilService : IB2CConsultaClientesEstadoCivilService
    {
        ...
        private static IB2CConsultaClientesEstadoCivilServiceCache _b2cConsultaClientesEstadoCivilCache { get; set; } = new B2CConsultaClientesEstadoCivilServiceCache();

        public B2CConsultaClientesEstadoCivilService(
            IAPICall apiCall,
            ILoggerService logger,
            ILinxMicrovixServiceBase linxMicrovixServiceBase,
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaClientesEstadoCivil> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            try
            {
                ...
                foreach (var cnpj_emp in cnpjs_emp)
                {
                    ...
                    var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaClientesEstadoCivilCache);
            ...
            finally
            {
                ...
                _b2cConsultaClientesEstadoCivilCache.AddList(_listSomenteNovos);
            }
