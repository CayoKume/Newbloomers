...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaColecoesService : IB2CConsultaColecoesService
    {
        ...
        public B2CConsultaColecoesService(
            ...
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaColecoes> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaColecoesCache);
