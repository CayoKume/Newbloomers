...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaUnidadeService : IB2CConsultaUnidadeService
    {
        ...
        private readonly ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaUnidade> _linxMicrovixRepositoryBase;
        ...
        public B2CConsultaUnidadeService(
            ...
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaUnidade> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaUnidadeCache);
