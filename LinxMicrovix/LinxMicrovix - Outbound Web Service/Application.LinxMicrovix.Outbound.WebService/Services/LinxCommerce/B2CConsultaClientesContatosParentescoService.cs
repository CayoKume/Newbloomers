...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaClientesContatosParentescoService : IB2CConsultaClientesContatosParentescoService
    {
        ...
        public B2CConsultaClientesContatosParentescoService(
            ...
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaClientesContatosParentesco> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaClientesContatosParentescoCache);
