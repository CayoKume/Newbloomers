...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaGrade2Service : IB2CConsultaGrade2Service
    {
        ...
        private readonly ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaGrade2> _linxMicrovixRepositoryBase;
        ...
        public B2CConsultaGrade2Service(
            ...
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaGrade2> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaGrade2Cache);
