...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaFormasPagamentoService : IB2CConsultaFormasPagamentoService
    {
        ...
        private static IB2CConsultaFormasPagamentoServiceCache _b2cConsultaFormasPagamentoCache { get; set; } = new B2CConsultaFormasPagamentoServiceCache();
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            try
            {
                ...
                foreach (var cnpj_emp in cnpjs_emp)
                {
                    ...
                    var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaFormasPagamentoCache);
            ...
            finally
            {
                ...
                _b2cConsultaFormasPagamentoCache.AddList(_listSomenteNovos);
            }
