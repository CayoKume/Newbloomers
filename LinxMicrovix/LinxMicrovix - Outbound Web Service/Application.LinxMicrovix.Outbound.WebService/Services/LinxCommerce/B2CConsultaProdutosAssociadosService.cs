...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaProdutosAssociadosService : IB2CConsultaProdutosAssociadosService
    {
        ...
        private static IB2CConsultaProdutosAssociadosServiceCache _b2cConsultaProdutosAssociadosCache { get; set; } = new B2CConsultaProdutosAssociadosServiceCache();
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaProdutosAssociadosCache);
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            finally
            {
                ...
                _b2cConsultaProdutosAssociadosCache.AddList(_listSomenteNovos);
            }
