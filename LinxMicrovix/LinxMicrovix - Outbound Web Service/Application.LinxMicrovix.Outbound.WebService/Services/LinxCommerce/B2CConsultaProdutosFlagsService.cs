...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaProdutosFlagsService : IB2CConsultaProdutosFlagsService
    {
        ...
        private static IB2CConsultaProdutosFlagsServiceCache _b2cConsultaProdutosFlagsCache { get; set; } = new B2CConsultaProdutosFlagsServiceCache();

        public B2CConsultaProdutosFlagsService(
            IAPICall apiCall,
            ILoggerService logger,
            ILinxMicrovixServiceBase linxMicrovixServiceBase,
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaProdutosFlags> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            try
            {
                ...
                foreach (var cnpj_emp in cnpjs_emp)
                {
                    ...
                    var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaProdutosFlagsCache);
            ...
            finally
            {
                ...
                _b2cConsultaProdutosFlagsCache.AddList(_listSomenteNovos);
            }
