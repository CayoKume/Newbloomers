...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaPalavrasChavePesquisaService : IB2CConsultaPalavrasChavePesquisaService
    {
        ...
        private static IB2CConsultaPalavrasChavePesquisaServiceCache _b2cConsultaPalavrasChavePesquisaCache { get; set; } = new B2CConsultaPalavrasChavePesquisaServiceCache();

        public B2CConsultaPalavrasChavePesquisaService(
            IAPICall apiCall,
            ILoggerService logger,
            ILinxMicrovixServiceBase linxMicrovixServiceBase,
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaPalavrasChavePesquisa> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            try
            {
                ...
                foreach (var cnpj_emp in cnpjs_emp)
                {
                    ...
                    var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaPalavrasChavePesquisaCache);
            ...
            finally
            {
                ...
                _b2cConsultaPalavrasChavePesquisaCache.AddList(_listSomenteNovos);
            }
