...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaImagensHDService : IB2CConsultaImagensHDService
    {
        ...
        private static IB2CConsultaImagensHDServiceCache _b2cConsultaImagensHDCache { get; set; } = new B2CConsultaImagensHDServiceCache();

        public B2CConsultaImagensHDService(
            IAPICall apiCall,
            ILoggerService logger,
            ILinxMicrovixServiceBase linxMicrovixServiceBase,
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaImagensHD> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaImagensHDCache);
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            finally
            {
                ...
                _b2cConsultaImagensHDCache.AddList(_listSomenteNovos);
            }
