...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaProdutosCustosService : IB2CConsultaProdutosCustosService
    {
        ...
        public B2CConsultaProdutosCustosService(
            ...
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaProdutosCustos> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaProdutosCustosCache);
