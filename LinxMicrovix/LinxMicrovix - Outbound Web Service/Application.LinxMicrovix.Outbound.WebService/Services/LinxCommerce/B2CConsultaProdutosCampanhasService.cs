...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaProdutosCampanhasService : IB2CConsultaProdutosCampanhasService
    {
        ...
        private readonly ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaProdutosCampanhas> _linxMicrovixRepositoryBase;
        ...
        public B2CConsultaProdutosCampanhasService(
            ...
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaProdutosCampanhas> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaProdutosCampanhasCache);
