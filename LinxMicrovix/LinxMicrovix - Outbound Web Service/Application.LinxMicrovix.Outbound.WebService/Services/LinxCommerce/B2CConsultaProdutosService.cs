...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaProdutosService : IB2CConsultaProdutosService
    {
        ...
        private static IB2CConsultaProdutosServiceCache _b2cConsultaProdutosCache { get; set; } = new B2CConsultaProdutosServiceCache();
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaProdutosCache);
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            finally
            {
                ...
                _b2cConsultaProdutosCache.AddList(_listSomenteNovos);
            }
