...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaPedidosPlanosService : IB2CConsultaPedidosPlanosService
    {
        ...
        private static IB2CConsultaPedidosPlanosServiceCache _b2cConsultaPedidosPlanosCache { get; set; } = new B2CConsultaPedidosPlanosServiceCache();

        public B2CConsultaPedidosPlanosService(
            IAPICall apiCall,
            ILoggerService logger,
            ILinxMicrovixServiceBase linxMicrovixServiceBase,
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaPedidosPlanos> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaPedidosPlanosCache);
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            finally
            {
                ...
                _b2cConsultaPedidosPlanosCache.AddList(_listSomenteNovos);
            }
