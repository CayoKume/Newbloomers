...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaPlanosService : IB2CConsultaPlanosService
    {
        ...
        public B2CConsultaPlanosService(
            ...
            ILinxMicrovixAzureSQLRepositoryBase<B2CConsultaPlanos> linxMicrovixRepositoryBase,
        ...
        public async Task<bool> GetRecord(LinxAPIParam jobParameter, string? identificador, string? cnpj_emp)
        {
            try
            {
                ...
                var xmls = _linxMicrovixServiceBase.DeserializeResponseToXML(jobParameter, response, _b2cConsultaPlanosCache);
