...
{
    public class B2CConsultaFlagsService<TEntity> : IB2CConsultaFlagsService<TEntity> where TEntity : B2CConsultaFlags, new()
    {
        private readonly IAPICall _apiCall;
        private readonly ILinxMicrovixServiceBase _linxMicrovixServiceBase;
        private readonly ILinxMicrovixRepositoryBase<TEntity> _linxMicrovixRepositoryBase;
        private readonly IB2CConsultaFlagsRepository<TEntity> _b2cConsultaFlagsRepository;

        public B2CConsultaFlagsService(
            IAPICall apiCall,
            ILinxMicrovixServiceBase linxMicrovixServiceBase,
            ILinxMicrovixRepositoryBase<TEntity> linxMicrovixRepositoryBase,
            IB2CConsultaFlagsRepository<TEntity> b2cConsultaFlagsRepository
        )
        {
            _apiCall = apiCall;
