using Domain.LinxCommerce.Entities.Sales.Order;

namespace Domain.LinxCommerce.Entities.Sales.Common
{
    public class Fulfillment
    {
        ...
        public OrderDeliveryMethod DeliveryMethod { get; set; } = new OrderDeliveryMethod();
