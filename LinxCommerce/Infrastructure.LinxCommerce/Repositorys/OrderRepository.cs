            ...
            try
            {
                ...
                for (int i = 0; i < records.Count(); i++)
                {
                    ...
                    if (records[i].Tags.Count() > 0)
                    {
                        ...
                        {
                            orderTagTable.Rows.Add(records[i].Tags[j].TagID, records[i].Tags[j].Alias, records[i].Tags[j].Name, records[i].Tags[j].IsSystem, records[i].Tags[j].IsDeleted, records[i].Tags[j].OrderID);
                        }
                    }
                    ...
                    if (records[i].Discounts.Count() > 0)
                    {
                        for (int j = 0; j < records[i].Discounts.Count(); j++)
                        {
                            orderDiscountTable.Rows.Add(
                                records[i].Discounts[j].Amount, records[i].Discounts[j].DiscountID, records[i].Discounts[j].Message, records[i].Discounts[j].Reference, records[i].Discounts[j].Type, records[i].Discounts[j].OrderID
                            );
                        }
                    }
