...
namespace Domain.LinxMicrovix.Outbound.WebService.Models.LinxCommerce
{
    public class B2CConsultaPedidos
    {
        ...
        public B2CConsultaPedidos(
            Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxCommerce.B2CConsultaPedidos record,
            string? recordXml
        )
        {
            ...
            this.finalizado = CustomConvertersExtensions.ConvertToInt32Validation(record.finalizado);
            ...
            this.valor_credito = CustomConvertersExtensions.ConvertToDecimalValidation(record.valor_credito);
