...
namespace Application.LinxMicrovix.Outbound.WebService.Services.LinxMicrovix
{
    public class LinxProdutosTabelasService : ILinxProdutosTabelasService
    {
        ...
        private readonly IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxProdutosTabelas> _validator;
        ...
        public LinxProdutosTabelasService(
            ...
            IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxProdutosTabelas> validator,
        ...
        public List<LinxProdutosTabelas?> DeserializeXMLToObject(LinxAPIParam jobParameter, List<Dictionary<string?, string?>> records)
        {
            ...
            for (int i = 0; i < records.Count(); i++)
            {
                try
                {
                    var entity = new Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxProdutosTabelas(
                    ...
                    list.Add(new LinxProdutosTabelas(entity, xml));
                }
                catch (Exception ex)
                {
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            if (xmls.Count() > 0)
            {
                ...
                {
                    var list = await _linxProdutosTabelasRepository.GetRegistersExists();
                    _linxProdutosTabelasCache = list.ToList();
                }
