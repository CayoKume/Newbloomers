...
namespace Application.LinxMicrovix.Outbound.WebService.Services.LinxMicrovix
{
    public class LinxB2CPedidosService : ILinxB2CPedidosService
    {
        ...
        private readonly IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxB2CPedidos> _validator;
        ...
        public LinxB2CPedidosService(
            ...
            IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxB2CPedidos> validator,
        ...
        public List<LinxB2CPedidos?> DeserializeXMLToObject(LinxAPIParam jobParameter, List<Dictionary<string?, string?>> records)
        {
            ...
            for (int i = 0; i < records.Count(); i++)
            {
                try
                {
                    var entity = new Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxMicrovix.LinxB2CPedidos(
                    ...
                    list.Add(new LinxB2CPedidos(entity, xml));
                }
                catch (Exception ex)
                {
        ...
        public async Task<bool> GetRecords(LinxAPIParam jobParameter)
        {
            ...
            if (xmls.Count() > 0)
            {
                ...
                {
                    var list = await _linxB2CPedidosRepository.GetRegistersExists(
                        jobParameter: jobParameter,
                    ...
                    _linxB2CPedidosCache = list.ToList();
                }
