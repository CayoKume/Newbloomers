...
namespace Application.LinxMicrovix.Outbound.WebService.Services
{
    public class B2CConsultaNFeSituacaoService : IB2CConsultaNFeSituacaoService
    {
        ...
        private readonly IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxCommerce.B2CConsultaNFeSituacao> _validator;
        ...
        public B2CConsultaNFeSituacaoService(
            ...
            IValidator<Domain.LinxMicrovix.Outbound.WebService.Dtos.LinxCommerce.B2CConsultaNFeSituacao> validator,
        ...
        public List<B2CConsultaNFeSituacao?> DeserializeXMLToObject(LinxAPIParam jobParameter, List<Dictionary<string?, string?>> records)
        {
            ...
            for (int i = 0; i < records.Count(); i++)
            {
                try
                {
                    ...
                    list.Add(new B2CConsultaNFeSituacao(entity, xml));
                }
                catch (Exception ex)
                {
