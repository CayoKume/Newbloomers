...
{
    public class B2CConsultaTransportadoresValidator : AbstractValidator<B2CConsultaTransportadores>
    {
        public B2CConsultaTransportadoresValidator()
        {
            RuleFor(x => x.cod_transportador).MustBeValidInt32().When(x => !string.IsNullOrEmpty(x.cod_transportador));
            RuleFor(x => x.nome).MaximumLength(60).WithMessage("O campo 'nome' deve ter no máximo 60 caracteres.").When(x => !string.IsNullOrEmpty(x.nome));
            ...
            RuleFor(x => x.tipo_pessoa).MaximumLength(1).WithMessage("O campo 'tipo_pessoa' deve ter no máximo 1 caractere.").When(x => !string.IsNullOrEmpty(x.tipo_pessoa));
            RuleFor(x => x.tipo_transportador).MaximumLength(1).WithMessage("O campo 'tipo_transportador' deve ter no máximo 1 caractere.").When(x => !string.IsNullOrEmpty(x.tipo_transportador));
            ...
            RuleFor(x => x.numero_rua).MaximumLength(20).WithMessage("O campo 'numero_rua' deve ter no máximo 20 caracteres.").When(x => !string.IsNullOrEmpty(x.numero_rua));
            ...
            RuleFor(x => x.documento).MaximumLength(14).WithMessage("O campo 'documento' deve ter no máximo 14 caracteres.").When(x => !string.IsNullOrEmpty(x.documento));
            RuleFor(x => x.fone).MaximumLength(20).WithMessage("O campo 'fone' deve ter no máximo 20 caracteres.").When(x => !string.IsNullOrEmpty(x.fone));
