...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaClientesContatosParentescoRepository : IB2CConsultaClientesContatosParentescoRepository
    {
        ...
        private readonly IB2CConsultaClientesContatosParentescoCommandHandler _commandHandler;

        public B2CConsultaClientesContatosParentescoRepository(ICoreRepository coreRepository, IB2CConsultaClientesContatosParentescoCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaClientesContatosParentesco());
