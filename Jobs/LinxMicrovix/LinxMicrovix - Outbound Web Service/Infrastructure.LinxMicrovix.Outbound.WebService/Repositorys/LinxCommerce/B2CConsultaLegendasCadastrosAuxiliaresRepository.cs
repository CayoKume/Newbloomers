...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaLegendasCadastrosAuxiliaresRepository : IB2CConsultaLegendasCadastrosAuxiliaresRepository
    {
        ...
        public B2CConsultaLegendasCadastrosAuxiliaresRepository(ICoreRepository coreRepository, IB2CConsultaLegendasCadastrosAuxiliaresCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaLegendasCadastrosAuxiliares());
