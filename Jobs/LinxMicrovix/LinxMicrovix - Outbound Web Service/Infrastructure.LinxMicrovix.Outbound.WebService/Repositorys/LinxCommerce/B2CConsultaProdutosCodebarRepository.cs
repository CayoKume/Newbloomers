...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosCodebarRepository : IB2CConsultaProdutosCodebarRepository
    {
        ...
        private readonly IB2CConsultaProdutosCodebarCommandHandler _commandHandler;

        public B2CConsultaProdutosCodebarRepository(ICoreRepository coreRepository, IB2CConsultaProdutosCodebarCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosCodebar());
        ...
        public async Task<IEnumerable<string?>> GetRegistersExists(LinxAPIParam jobParameter, List<B2CConsultaProdutosCodebar> registros)
        {
