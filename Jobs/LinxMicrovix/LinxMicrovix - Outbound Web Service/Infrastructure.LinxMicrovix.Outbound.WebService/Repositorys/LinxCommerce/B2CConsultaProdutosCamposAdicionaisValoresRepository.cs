...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosCamposAdicionaisValoresRepository : IB2CConsultaProdutosCamposAdicionaisValoresRepository
    {
        ...
        public B2CConsultaProdutosCamposAdicionaisValoresRepository(ICoreRepository coreRepository, IB2CConsultaProdutosCamposAdicionaisValoresCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosCamposAdicionaisValores());
