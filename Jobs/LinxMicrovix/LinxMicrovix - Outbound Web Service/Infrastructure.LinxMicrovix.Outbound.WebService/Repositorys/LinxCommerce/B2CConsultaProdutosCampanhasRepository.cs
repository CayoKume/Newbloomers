...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosCampanhasRepository : IB2CConsultaProdutosCampanhasRepository
    {
        ...
        public B2CConsultaProdutosCampanhasRepository(ICoreRepository coreRepository, IB2CConsultaProdutosCampanhasCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosCampanhas());
