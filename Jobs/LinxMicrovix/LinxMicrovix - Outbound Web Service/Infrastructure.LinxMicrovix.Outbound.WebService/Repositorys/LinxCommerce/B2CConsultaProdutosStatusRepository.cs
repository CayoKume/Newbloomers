...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxCommerce
{
    public class B2CConsultaProdutosStatusRepository : IB2CConsultaProdutosStatusRepository
    {
        ...
        public B2CConsultaProdutosStatusRepository(ICoreRepository coreRepository, IB2CConsultaProdutosStatusCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new B2CConsultaProdutosStatus());
