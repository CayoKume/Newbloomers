...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxMovimentoRepository : ILinxMovimentoRepository
    {
        ...
        public LinxMovimentoRepository(ICoreRepository coreRepository, ILinxMovimentoCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxMovimento());
