...
namespace Infrastructure.LinxMicrovix.Outbound.WebService.Repository.LinxMicrovix
{
    public class LinxNaturezaOperacaoRepository : ILinxNaturezaOperacaoRepository
    {
        ...
        public LinxNaturezaOperacaoRepository(ICoreRepository coreRepository, ILinxNaturezaOperacaoCommandHandler commandHandler)
        {
        ...
        {
            var table = _coreRepository.CreateSystemDataTable(jobParameter.tableName, new LinxNaturezaOperacao());
