...
{
    public class LabelsCommandHandler : ILabelsCommandHandler
    {
        public string CreateGetOrdersToPresentQuery(string cnpj_emp, string serie, string nr_pedido)
        {
            return $@"SELECT
                         DOCUMENTO AS NUMBER,
                         SUBSTRING (
        ...
        public string CreateGetOrdersToPrintQuery(string cnpj_emp, string serie, string data_inicial, string data_final)
        {
        ...
        public string CreateGetOrderToPrintQuery(string cnpj_emp, string serie, string nr_pedido)
        {
            return $@"SELECT DISTINCT
                        TRIM(A.DOCUMENTO) AS NUMBER,
                        A.VOLUMES AS VOLUMES,
        ...
        public string CreateUpdatePrintedFlagQuery(string nr_pedido)
        {
            return $@"UPDATE [GENERAL].[dbo].[IT4_WMS_DOCUMENTO] SET 
