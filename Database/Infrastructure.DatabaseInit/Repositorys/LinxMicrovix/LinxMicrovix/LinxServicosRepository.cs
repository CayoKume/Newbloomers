...
namespace Infrastructure.DatabaseInit.Repositorys.LinxMicrovix.LinxMicrovix
{
    public class LinxServicosRepository : ILinxServicosRepository
    {
        ...
        public LinxServicosRepository(ISQLServerConnection? conn) =>
            _conn = conn;
        ...
        public bool CreateTableIfNotExists(string databaseName, string jobName, string untreatedDatabaseName)
        {
            ...
            try
            {
                using (var conn = _conn.GetIDbConnection(databaseName))
                {
                    ...
                    if (result.Count() == 0)
                        conn.CreateTable<Domain.DatabaseInit.Entities.LinxMicrovix.Trusted.LinxMicrovix.LinxServicos>();
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                using (var conn = _conn.GetIDbConnection(untreatedDatabaseName))
                {
                    ...
                    if (result.Count() == 0)
                        conn.CreateTable<Domain.DatabaseInit.Entities.LinxMicrovix.Untreated.LinxMicrovix.LinxServicos>();
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                var parameter = new
                {
                    ...
                    timestamp = @"<Parameter id=""timestamp"">[0]</Parameter>
                                                <Parameter id=""id_linha"">[id_linha]</Parameter>
                                                <Parameter id=""id_marca"">[id_marca]</Parameter>
                                                <Parameter id=""id_setor"">[id_setor]</Parameter>
                                                <Parameter id=""dt_update_inicio"">[dt_update_inicio]</Parameter>
                    ...
                    individual = @"<Parameter id=""timestamp"">[0]</Parameter>
                                                <Parameter id=""cod_servico"">[cod_servico]</Parameter>
                                                <Parameter id=""id_linha"">[id_linha]</Parameter>
                                                <Parameter id=""id_marca"">[id_marca]</Parameter>
                                                <Parameter id=""id_setor"">[id_setor]</Parameter>
                                                <Parameter id=""dt_update_inicio"">[dt_update_inicio]</Parameter>
