...
namespace Infrastructure.LinxMicrovix.Outbound.WebService
{
    public static class ServicesExtensions
    {
        ...
        {
            // ILoggerAuditoria_Config config = new LoggerAuditoria_Config();
            // services.AddSingleton(typeof(ILoggerAuditoria_Config), config);
            services.AddSingleton<ILoggerConfig, LoggerConfig>();

            // Initiliza repositórios  de logs
            ...
            // Initilizerepositorio de dados
            // services.AddSingleton(typeof(ILoggerAuditoria), typeof(LoggerAuditoria));
            services.AddScoped<ILoggerAuditoriaService, LoggerAuditoriaService>();

            // Sistema de Cacheamento
