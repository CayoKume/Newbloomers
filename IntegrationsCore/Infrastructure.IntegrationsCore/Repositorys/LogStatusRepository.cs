...
namespace IntegrationsCore.Infrastructure.Repository.LogStatusRepository
{
    public class LogStatusRepository : ILogStatusRepository
    {
        ...
        //                  EnumMessageLevel.Error, EnumIdMsgType.SqlInsert, ex.Message
        //                ).AddLog(step: EnumSteps.Default,error: EnumIdMsgType.SQLCommand, level: EnumMessageLevel.Debug, message: cmdText);
        //    }
        //}
        ...
        //    _SqlBuilder.Add<EnumMessageLevel>("IdLogLevel", status.IdLogLevel);
