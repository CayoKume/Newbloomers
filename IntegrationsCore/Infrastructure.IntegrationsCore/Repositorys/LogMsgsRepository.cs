...
namespace IntegrationsCore.Infrastructure.Repository.LogMsgsRepository
{
    ...
    public class LogMsgsRepository : ILogMsgsRepository
    {
        ...
        //            EnumMessageLevel.Error, EnumIdMsgType.SqlInsert);
        //    }
        //}
        ...
        //    _SqlBuilder.Add<EnumIdMsgType>("IdMsgType", logMsg.IdError);
        //    _SqlBuilder.Add<EnumIdDomain>("IdDomain", logMsg.IdDomain);
        //    _SqlBuilder.Add<EnumMessageLevel>("IdLogLevel", logMsg.IdLogLevel);
        ...
        //    _SqlBuilder.Add<EnumSteps>("IdStep", logMsg.IdStep);
