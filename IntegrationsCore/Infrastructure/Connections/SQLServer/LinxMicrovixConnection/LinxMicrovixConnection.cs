...
{
    public class LinxMicrovixConnection : ILinxMicrovixConnection, IDisposable
    {
        ...
        public LinxMicrovixConnection(IConfiguration configuration) 
        {
            _databaseName = configuration.GetSection("ConfigureServer").GetSection("LinxMicrovixDatabaseName").Value;
